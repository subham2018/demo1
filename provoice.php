...
<?php include_once 'include/navbar.php';?>	
        <div class="content">
            ...
            <div class="top">
            	<p class="page-title"><i class="fa fa-file-text-o fa-fw"></i>Create Proforma Invoice</p>
                <ol class="breadcrumb">
                    <li><a href="index.php">Dashboard</a></li>
                    <li><a href="proforma_bill.php">View Proforma Invoice</a></li>
                    <li class="active">Create Proforma Invoice</li>
                </ol>
            </div>
            <!--main content start-->
            <div class="main-body">
                <div class="panel panel-default">
                    <div class="panel-body">
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <select class="form-control" required id="pid">
                                        ...
                                        <?php
                                        $select=mysql_query("SELECT * FROM ".$prefix."purchase");
                                        while($row=mysql_fetch_object($select)){
                                        
                                        ?>
                                        <option value="<?=$row->id?>"><?=$row->name?> [<?=$row->business?>]</option>
                                        <?php }?>
                                    </select>
                                </div>
                                ...
                                <table class="table table-bordered">
                                    <tr>
                                        <td>
                                            ...
                                            <input type="text" data-name="bill" placeholder="Eg. 127/FC/17-18">
                                        </td>
                                        <td>
                                            <strong>Dated:</strong>
                                            <input type="text" data-mask="9999-99-99" data-name="bdate" placeholder="Eg. yyyy-mm-dd">
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                            <strong>Challan No.:</strong>
                                            <input type="text" data-name="challan" placeholder="Eg. xxxxxxxx">
                                        </td>
                                        <td>
                                            <strong>Dated:</strong>
                                            <input type="text" data-mask="9999-99-99" data-name="cdate" placeholder="Eg. yyyy-mm-dd">
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                            <strong>Buyer's Order No.:</strong>
                                            <input type="text" data-name="order_id" placeholder="Eg. xxxxxxxx">
                                        </td>
                                        <td>
                                            <strong>Dated:</strong>
                                            <input type="text" data-mask="9999-99-99" data-name="odate" placeholder="Eg. yyyy-mm-dd">
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                            <strong>Despatched Doc. No.:</strong>
                                            <input type="text" data-name="desdoc" placeholder="Eg. xxxxxxxx">
                                        </td>
                                        <td>
                                            <strong>Despatched Through:</strong>
                                            <input type="text" data-name="desthr" placeholder="Enter Details">
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                            <strong>Destination:</strong>
                                            <input type="text" data-name="dest" placeholder="Enter details">
                                        </td>
                                        <td>
                                            <strong>Delivery Note Date:</strong>
                                            <input type="text" data-name="delnote" data-mask="9999-99-99" placeholder="Eg. yyyy-mm-dd">
                                        </td>
                                    </tr>
                                    <tr>
                                        <td colspan="2">
                                            <strong>Mode/Terms of Payment:</strong>
                                            <input type="text" data-name="mode" placeholder="Enter details">
                                        </td>
                                    </tr>
                                </table>
                            </div>
                        ...
                        <form action="proforma_bill.php"  method="post">
                            ...
                            <input type="hidden" name="note" value="" required>
                             <input type="hidden" name="pay_status" value="" required>
                        	<input type="hidden" name="delnote" value="" required>
                            <input type="hidden" name="per" value="" required>
                            <input type="hidden" name="ptype" value="" required>
	                        ...
	                        <table class="table table-bordered item">
	                            ...
	                            <tfoot>
	                                <tr style="background-color: #eee">
	                                    <td><strong>GROSS TOTAL(Rounded) (incl. tax)</strong></td>
	                                    <td></td>
	                                    <td></td>
	                                    <td></td>
	                                    <td class="bttl">0.00</td>
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    <p>Net Amount (incl. tax) (in words): <strong id="inword"><?=numtowords(number_format(0,2,'.',''))?></strong></p>
                                </div>
	                        ...
	                        <div class="row">
	                            <div class="col-sm-6">
	                                <div class="form-group">
	                                    ...
	                                    <textarea name="term" class="form-control" id="dct" rows="3"><?=$site->invoice_term?></textarea>
	                                </div>
	                            </div>
	                            <div class="col-sm-6">
	                                <div class="form-group">
	                                    <label>Account Details</label>
	                                    <textarea name="account" class="form-control" id="ad" rows="5"><?=htmlspecialchars_decode(anything('software_setting','bank_account',1))?></textarea>
	                                </div>
	                            </div>
	...
	$('[data-name="bdate"],[data-name="odate"],[data-name="cdate"],[data-name="delnote"]').datepicker({format:'yyyy-mm-dd'});
      ...
      $('.item>tbody').on('change','.item-box',function(event) {
            ...
            if(($this.val() != 'p+') && ($this.val() != 'p-')){
                ...
                if($this.val() == 'p+'){
                    $this.closest('td').html($('<input name="item[]" type="text" placeholder="Enter particulars (Add type)" value=""><input name="ptype[]" type="hidden" value="+"><button class="close"><i class="fa fa-trash fa-fw"></i></button><br><small class="text-muted">(+)Add Type. This info text will not be printed.</small>'));
                }
                else if($this.val() == 'p-'){
                    $this.closest('td').html($('<input name="item[]" type="text" placeholder="Enter particulars (Minus type)" value=""><input name="ptype[]" type="hidden" value="-"><button class="close"><i class="fa fa-trash fa-fw"></i></button><br><small class="text-muted">(-)Minus Type. This text will not be printed.</small>'));
                }
            }
      });

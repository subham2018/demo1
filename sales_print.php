...
if(isset($_GET['id'],$_GET['t'])){
    ...
    $b_id=$_GET['id'];
    $select=mysqli_query($link,"SELECT * FROM ".$prefix."purcheser_bill WHERE `id`='".$b_id."'");
    ...
    $s = mysqli_query($link,"SELECT * FROM ".$prefix."purcheser_invoice WHERE `inv_id` ='".$b_id."' ORDER BY `id`");
    ...
    <small align="right" style="font-size:10px">('.$copy.')</small>

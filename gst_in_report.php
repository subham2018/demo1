...
<body>
        ...
        <div class="content">
            ...
            <div class="top">
                <p class="page-title"><i class="fa fa-clipboard fa-fw"></i> OUTPUT GST Report</p>
                <ol class="breadcrumb">
                    <li><a href="index.php">Dashboard</a></li>
                    <li><a href="#"></a>Report</li>
                   <!--  <li><a href="operations.php">Operations</a></li> -->
                    <li class="active">OUTPUT GST Report</li>
...
$('#Service_list').DataTable( {
    ...
    "buttons": [
        ...
        // {'filename':'INPUT GST Report','extend':'csv','exportOptions':{'columns':':visible'},'text':'<i class="fa fa-file-text fa-fw"></i> CSV'},
        // {'filename':'INPUT GST Report','extend':'excel','exportOptions':{'columns':':visible'},'text':'<i class="fa fa-file-excel-o fa-fw"></i> Excel'},
        // {'filename':'INPUT GST Report','extend':'pdf','orientation':'landscape','pageSize':'A4','exportOptions':{'columns':':visible'},'text':'<i class="fa fa-file-pdf-o fa-fw"></i> PDF'},
        ...
        'customize':function(win){
            ...
            $(win.document.body).prepend('<h3>Fire Check - '+$('#name').find('option:selected').text()+' OUTPUT GST Report</h3>')

            $(win.document.body).append('<hr>')
            $(win.document.body).append('<p>TOTAL GST RECEIVED: <strong>INR '+calcTd(5)+'</strong></p>');
        }}
    ]
});

	                        ...
	                        <table class="table table-bordered item">
                                ...
                                while($r=mysql_fetch_object($s)){?>
                                    <tr>
                                        ...
                                        <td><input name="qty[]" min="0" step="0.01" type="number" value="<?=$r->stock?>"><br><input name="unit[]" type="text" maxlength="50" style="border-top:thin solid #ccc" placeholder="Unit" value="<?=$r->unit?>"></td>
                                        <td><input name="rate[]" min="0" step="0.01" type="number" value="<?=$r->price?>"></td>
                                        <td class="bttl">0.00</td>
                                        <td><input name="sgst[]" min="0" step="0.01" max="100" type="number" value="<?=$r->sgst?>"></td>
                                        <td class="stl">0.00</td>
                                        <td><input name="cgst[]" min="0" step="0.01" max="100" type="number" value="<?=$r->cgst?>"></td>
                                        <td class="ctl">0.00</td>
                                        <td><input name="igst[]" min="0" step="0.01" max="100" type="number" value="<?=$r->igst?>"></td>

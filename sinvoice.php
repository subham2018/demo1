...
<?php include_once 'include/navbar.php';?>	
        <div class="content">
            ...
            <div class="top">
            	<p class="page-title"><i class="fa fa-file-text-o fa-fw"></i> Purchase Invoice</p>
                <ol class="breadcrumb">
                                ...
                                <table class="table table-bordered">
                                    ...
                                    <tr>
                                        <td>
                                            ...
                                            <input type="text" data-name="pterm"  placeholder="Enter Details">
                                        </td>
                                        <td>
                                            <strong>Other Ref.:</strong>
                                            <input type="text" data-name="oref" placeholder="Enter Details">
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                    ...
                                    <tr>
                                        <td>
                                            ...
                                            <input type="text" data-name="delnote" placeholder="Enter Details">
                                        </td>
                                        <td>
                                            <strong>Delivery Note Date:</strong>
                                            <input type="text" data-mask="9999-99-99" data-name="ddate" placeholder="Eg. yyyy-mm-dd">
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                    ...
                                    <tr>
                                        <td colspan="2">
                                            ...
                                            <textarea data-name="delterm"  placeholder="Enter Details"></textarea>
                                        </td>
                                    </tr>
                                </table>
                            </div>
	                        ...
	                        <table class="table table-bordered item">
	                            ...
	                            <tbody>
	                                <tr>
	                                    ...
	                                    <td><input name="qty[]" min="0" type="number" step="0.01" value="0"><br><input name="unit[]" type="text" value="" maxlength="50" style='border-top:thin solid #ccc' placeholder="Unit"></td>
	                                    <td><input name="rate[]" min="0" step="0.01" type="number" value="0.00"></td>
	                                    <td class="bttl">0.00</td>
	                                    <td><input name="sgst[]" min="0" step="0.01" max="100" type="number" value="0"></td>
	                                    <td class="stl">0.00</td>
	                                    <td><input name="cgst[]" min="0" step="0.01" max="100" type="number" value="0"></td>
	                                    <td class="ctl">0.00</td>
	                                    <td><input name="igst[]" min="0" step="0.01" max="100" type="number" value="0"></td>
	                        ...
	                        <div class="row">
	                            <!-- <div class="col-sm-12">
	                                <div class="form-group">
	                                    ...
	                                    <textarea name="term" class="form-control" id="dct" rows="3"></textarea>
	                                </div>
	                            </div> -->

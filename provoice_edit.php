...
if(isset($_GET['id'])) $inv = row('proforma_bill',$_GET['id']);
else header('location: proforma_bill.php')
?>
<!doctype html>
<html>
<head>
...
<?php include_once 'include/navbar.php';?>	
        <div class="content">
            ...
            <div class="top">
            	<p class="page-title"><i class="fa fa-file-text-o fa-fw"></i> Proforma Invoice Edit</p>
                <ol class="breadcrumb">
                    <li><a href="index.php">Dashboard</a></li>
                    <li><a href="proforma_bill.php">View Proforma Invoice</a></li>
                    <li class="active">Proforma Invoice Edit</li>
                </ol>
            </div>
            <!--main content start-->
            <div class="main-body">
                    ...
                    <div class="panel-body">
                        ...
                        <form action="proforma_bill.php"  method="post">
	                        ...
	                        <table class="table table-bordered item">
	                            ...
	                            <tbody>
                                <?php
                                $s = mysqli_query($link,"SELECT * FROM ".$prefix."proforma_invoice WHERE `inv_id` ='".$inv->id."'");

...
<?php include_once 'include/navbar.php';?>	
        <div class="content">
            ...
            <div class="top">
            	<p class="page-title"><i class="fa fa-cubes fa-fw"></i> Item Invoice</p>
                <ol class="breadcrumb">
                    <li><a href="index.php">Dashboard</a></li>
                    <li><a href="selling_invoice.php">Seller Billing</a></li>
                    <li class="active">Item Invoice</li>
                </ol>
            </div>
             <!--main content start-->
            <div class="main-body">
                ...
                if(isset($_POST['submit'])){
                    ...
                    if(mysql_query("INSERT INTO ".$prefix."item_invoice SET ".$query)){
                        mysql_query("INSERT INTO ".$prefix."stock_manage SET `sc_id`='".$_POST['item_id']."',`stock`='".$_POST['stock']."',`type`='purchase',`ref_id`='".mysql_insert_id()."'");
                ...
                if(isset($_POST['usubmit'])){
                    ...
                    $prevstock = intval(anything('item_invoice','stock',$_POST['pid']));

                    if(mysql_query("UPDATE ".$prefix."item_invoice SET ".$query." WHERE `id`=".$_POST['pid'])){
                        mysql_query("UPDATE ".$prefix."stock_manage SET `sc_id`='".$_POST['item_id']."',`stock`='".$_POST['stock']."' WHERE `ref_id`='".$_POST['pid']."'");

                        $stock = intval(anything('subcategory','stock',$_POST['item_id'])) - $prevstock + intval($_POST['stock']);
                        mysql_query("UPDATE ".$prefix."subcategory SET `stock`='".$stock."' WHERE `id`=".$_POST['item_id']);
                 ...
                 if(isset($_GET['del'])){
                    ...
                    if(mysql_query("DELETE FROM ".$prefix."item_invoice WHERE id=".variable_check($_GET['del']))){ //delete info
                ...
                <div class="panel panel-default" id="addnew" style="display:none;">
                    <div class="panel-heading">
                        <div class="panel-title"><i class="fa fa-plus fa-fw"></i> Add New Item Invoice</div>
                    </div>
                    <div class="panel-body">
                        <form action="" class="form-horizontal" method="post" enctype="multipart/form-data">
                        <input type="hidden" name="seller_bill" value="<?=$_GET['id']?>">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="number" class="form-control" name="stock" id="" min="0" placeholder="Enter Stock Quantity" required>
                                </div>
                            </div>                    
                            <div class="form-group">
                                <label class="col-sm-2 control-label">Base Price</label>
                                <div class="col-sm-10">
                                    <input type="number" class="form-control" name="price" id="" min="0" placeholder="Enter Amount" required>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-2 control-label">IGST (%)</label>
                                <div class="col-sm-10">
                                    <input type="number" step="1" class="form-control" name="igst" id="" min="0"  max="100" placeholder="Enter IGST Percentage" required>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-2 control-label">CGST (%)</label>
                                <div class="col-sm-10">
                                    <input type="number" step="1" class="form-control" name="cgst" id="" min="0"  max="100" placeholder="Enter CGST Percentage" required>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-2 control-label">SGST (%)</label>
                                <div class="col-sm-10">
                                    <input type="number" step="1" class="form-control" name="sgst" id="" min="0"  max="100" placeholder="Enter SGST Percentage" required>
                                </div>
                            </div>                          
                ...
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <div class="panel-title"><i class="fa fa-list fa-fw"></i> Item Invoice List <button onClick="$('#addnew').show('slow')" class="btn btn-sm btn-primary pull-right"> Add Stock</button></div>
                    </div>
                    <div class="panel-body">
                        <table id="Projects_list" class="table table-hover table-bordered table-condensed" cellspacing="0" width="100%">
                            ...
                            <tbody>
                                <?php
                                $select=mysql_query("SELECT * FROM ".$prefix."item_invoice WHERE `seller_bill` ='".$_GET['id']."'");
                                while($row=mysql_fetch_object($select)){
                                ?>
                                <tr>
                  ...
                  <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            ...
                            <h4 class="modal-title">View / Item Invoice</h4>
                        </div>
                        <div class="modal-body clearfix">                           
                                <form action="" class="form-horizontal" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        <label class="col-sm-2 control-label">Base Price</label>
                                        <div class="col-sm-10">
                                            <input type="number" class="form-control" name="price" id="price" min="0" placeholder="Enter Amount" required>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-sm-2 control-label">IGST (%)</label>
